        ...
        <section className="video-form-page page-fade-up">
            <div className="video-form-top">
                <div className="video-form-title-wrap">
                    ...
                    <div>
                        <h1>{isEdit ? "Edit Video" : "Add New Video"}</h1>
                        <p>Fill all the video details below</p>
                    </div>
                </div>
                ...
                <div className="video-form-top-actions">
                    ...
                    <button className="video-form-save-btn" onClick={handleSubmit} disabled={loading}>
                        <FiSave />
                        {loading ? "Saving..." : isEdit ? "Update Video" : "Publish Video"}
                    </button>
                </div>
            </div>
            ...
            <div className="video-form-grid">
                ...
                <div className="video-form-col">
                    ...
                    <div className="video-form-card">
                        <h3 className="video-form-card-title">Video Links</h3>
                    ...
                    <div className="video-form-card">
                        ...
                        <p className="video-status-hint">
                            {formData.status === "draft"
                                ? "This video will stay hidden on the website until it's Published."
                                : "This video will be visible to everyone on the website."}
                        </p>
                    </div>
                </div>
                ...
                <div className="video-form-col">
                    <div className="video-form-card">
                        <h3 className="video-form-card-title">Video Details</h3>
                        ...
                        <div className={`video-slug-wrap ${errors.slug ? "input-error" : ""}`}>
                            <span className="video-slug-prefix">yourwebsite.com/video/</span>
                            <input
                                type="text"
                                placeholder="video-title"
                                value={formData.slug}
                        ...
                        <span className="field-hint">
                            Tags improve the video's search visibility.
                        </span>
