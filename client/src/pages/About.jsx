  ...
  return (
    <section className="about-page-section">
      ...
      <div className="container">
        ...
        <div className="about-hero-card fade-up fade-up-delay-2">
        ...
        <div className="about-content-card fade-up fade-up-delay-3">
          ...
          <div className="about-block">
            <h3 className="about-block-title">خاندانی روایت اور ذاتی جذبہ</h3>
          ...
          <div className="about-block">
            <h3 className="about-block-title">15 سالہ تجربہ اور فنِ تشخیص</h3>
            <p className="about-content-text">
              ...
              بیماری کی تشخیص اور علاج کرتے ہیں، لیکن درج ذیل مسائل میں انہیں
              خاص مہارت حاصل ہے:
            </p>
          ...
          <div className="about-block">
            ...
            <p className="about-content-text">
              ...
              تمام مراحل خود اپنی نگرانی میں مکمل کرتے ہیں۔ ان کے تیار کردہ
              نسخہ جات ان کے برسوں کے تجربے اور تحقیق کا نچوڑ ہیں۔
            </p>
          </div>

          <div className="about-block">
            <h3 className="about-block-title">قانونی حیثیت اور رجسٹریشن</h3>
            <p className="about-content-text">
          ...
          <div className="about-block">
            ...
            <p className="about-content-text">
              ...
              دیکھا جانا اس بات کی دلیل ہے کہ عوام کا ان پر بھروسہ غیر متزلزل
              ہے۔ یہی اعتماد اب اس ویب سائٹ کی صورت میں آپ کے سامنے ہے تاکہ آپ
              براہِ راست مستند مشورہ حاصل کر سکیں۔
            </p>
          </div>

          <div className="about-block">
            <h3 className="about-block-title">خدمتِ انسانیت کا مشن</h3>
            <p className="about-content-text">
